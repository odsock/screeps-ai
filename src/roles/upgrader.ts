...
export class Upgrader extends CreepWrapper {
  public run() {
    super.run();
  ...
  private buildNearbySite(site: ConstructionSite<BuildableStructureConstant>) {
  ...
  private withdrawAndUpgrade(): ScreepsReturnCode {
  ...
  private moveToRetiree(): ScreepsReturnCode {
  ...
  private moveToFreeContainer(): ScreepsReturnCode {
